...
const Gallery = () => {
  ...
  return (
    <div className="mx-2 sm:mx-4 bg-slate-900/80 backdrop-blur-sm rounded-xl p-6 sm:p-8 border border-slate-800/50 shadow-xl">
      <title>Photo Gallery | April's Lil Pugs</title>
      <meta
        name="description"
        content="A curated gallery of our Pugs, puppies, and life at April's Lil Pugs."
      />
      <meta property="og:title" content="Gallery | April's Lil Pugs" />
      <meta property="og:url" content="https://aprilslilpugs.com/gallery" />
