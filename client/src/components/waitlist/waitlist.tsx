...
interface WaitlistProps {
  createEntry: (data: Partial<WaitlistEntry>) => Promise<any>;
...
const Waitlist = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(
        `Congratulations! You've been added to the waitlist at position #${currentPosition}`,
      );
      setFormData({
        firstName: "",
        lastName: "",
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              ...
              >
                {isSubmitting ? <p>Loading...</p> : "Join Waitlist"}
              </button>
            </div>
          </form>
        </div>
