...
const WaitlistAdmin = () => {
    ...
    return (
        <div className="mx-0 sm:mx-4">
            <div className="bg-slate-900/80 backdrop-blur-sm rounded-xl p-2 sm:p-8 border border-slate-800/50 shadow-xl">
                <h2 className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 mb-4 sm:mb-8 px-2 sm:px-0">
                    Waitlist Management
                </h2>
