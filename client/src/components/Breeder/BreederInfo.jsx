                ...
                {breeder.images.map((imageUrl, index) => (
                  <div key={index} className="relative group">
                    ...
                    <img
                      ...
                      className="relative w-full aspect-square object-cover rounded-xl border-2 border-white/10 shadow-xl"
                    />
                  </div>
                ))}
              </div>
