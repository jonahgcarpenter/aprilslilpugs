...
// Protected routes
router.post('/', requireAuth, littersUpload.fields([
    { name: 'profilePicture', maxCount: 1 }
]), createLitter);
router.patch('/:litterId', requireAuth, littersUpload.fields([
    { name: 'profilePicture', maxCount: 1 }
]), updateLitter);
router.delete('/:litterId', requireAuth, deleteLitter);

// Protected puppy routes
router.post('/:litterId/puppies', requireAuth, puppyUpload.fields([
    { name: 'profilePicture', maxCount: 1 }
]), addPuppy);
router.patch('/:litterId/puppies/:puppyId', requireAuth, puppyUpload.fields([
    { name: 'profilePicture', maxCount: 1 }
]), updatePuppy);
