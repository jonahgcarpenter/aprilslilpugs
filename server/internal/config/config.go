...
type Config struct {
	...
	JWTSecret          string
	LogLevel           string
	PublicStorageRoot  string
	PrivateStorageRoot string
	HLSStorageRoot     string
...
func Load() *Config {
	...
	return &Config{
		...
		DatabaseRoot:       getEnv("DATABASE_ROOT", "./data/private/database"),
		JWTSecret:          getEnv("JWT_SECRET", "verylongsecret"),
		LogLevel:           getEnv("LOG_LEVEL", "info"),
		PublicStorageRoot:  getEnv("PUBLIC_STORAGE_ROOT", getEnv("STORAGE_ROOT", "./data/public/images")),
		PrivateStorageRoot: getEnv("PRIVATE_STORAGE_ROOT", "./data/private/files"),
		HLSStorageRoot:     getEnv("HLS_STORAGE_ROOT", "./data/public/hls"),
